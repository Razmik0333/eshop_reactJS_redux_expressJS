          ...
          <footer>
               <div className="container footer__container">
                    <div className="footer__top">
                         ...
                         <div className="footer__row">
                              <ul className="footer__row__categories">
                                   <li className="footer__row__category">ORDERS</li>
                                   <li className="footer__row__category">Payment options</li>
                                   <li className="footer__row__category">Shipping and delivery</li>
