               ...
               <div className="user__page__settings">
                    <div className="user_nav">
                         <ul className="user_nav_items">
                              ...
                              <li className="user_nav_item"><NavLink to={"/user/orders"} className="user_nav_link">Orders</NavLink></li>
                              <li className="user_nav_item"><NavLink to={'/user/products'} className="user_nav_link">Products</NavLink></li>
                              <li className="user_nav_item"><NavLink to={'/personal'} className="user_nav_link">Personal data</NavLink></li>
                              <li className="user_nav_item"><NavLink to={'/user/reviews'} className="user_nav_link">Reviews</NavLink></li>
