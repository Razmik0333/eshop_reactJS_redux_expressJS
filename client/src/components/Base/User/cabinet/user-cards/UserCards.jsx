...
import "./styles/_user-cards.scss"
  ...
  return (
     ...
     <MenuBar/>
     {
          <div className="card__items">
               <div className="card__item">
                    <div className="card__item__body">
                         <div className="card__content">
                              <p className="card__header">Քարտի Համար</p>
                              <p className="card__number">****3791</p>
                         </div>
                         <div className="payment__system__icon">
                         <svg enable-background="new 0 0 32 20" height="20" overflow="visible" viewBox="0 0 32 20" width="32">
                              <g>
                                   <g id="Master_Card_1_">
                                        <g id="Master_Card">
               ...
               <NavLink to={'/user/card/add'}>
                    <div className="card__item add_card">
