...
var ORDER_SAVE = 'adminOrderDuck/ORDER_SAVE';
...
var orderSave = (0, _redux.createAction)(ORDER_SAVE);
...
var fetchOrdersChanges = function fetchOrdersChanges() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return regeneratorRuntime.awrap(fetch("".concat(_constants.root, "/api/admin/orders/save")));
...
exports.fetchOrdersChanges = fetchOrdersChanges;

var fetchOrdersList = function fetchOrdersList() {
