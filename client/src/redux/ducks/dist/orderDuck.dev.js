...
exports["default"] = exports.getOrderStatus = exports.fetchDeletedOrder = exports.fetchDeliveredOrdersByUser = exports.changeOrderStatus = exports.fetchProductsByOrder = exports.fetchUserOrdersByStatus = exports.fetchProductsByOrderId = exports.fetchUserOrders = exports.emptyOrders = exports.getProductQuantity = exports.orderConfirm = exports.orderEvaluateId = exports.orderConfirmId = exports.clearOrders = exports.fetchOrderData = exports.changeOrdersFromLogout = exports.getEvaluateProducts = exports.getEvaluateProductId = exports.getDeliveredOredersByUser = exports.changeConfirmed = exports.changeOrderForConfirm = exports.changeStatus = exports.getCurrentStatus = exports.getProductsCount = exports.fetchProducts = exports.fetchOrders = void 0;
...
var DELETE_ID = 'orderDuck/DELETE_ID';
var DELIVERED_ORDERS_BY_USER = 'orderDuck/DELIVERED_ORDERS_BY_USER';
var EVALUATE_PRODUCT_ID = 'orderDuck/EVALUATE_PRODUCT_ID';
var EVALUATE_PRODUCTS = 'orderDuck/EVALUATE_PRODUCTS'; // const CLEAR_ORDER_FROM_STATUS = 'orderDuck/CLEAR_ORDER_FROM_STATUS';
...
var getEvaluateProductId = (0, _redux.createAction)(EVALUATE_PRODUCT_ID);
exports.getEvaluateProductId = getEvaluateProductId;
var getEvaluateProducts = (0, _redux.createAction)(EVALUATE_PRODUCTS);
exports.getEvaluateProducts = getEvaluateProducts;
var initialStateApp = {
  ordersData: [],
  orderProducts: {},
  deliveredOrders: [],
...
var orderEvaluateId = function orderEvaluateId(id) {
  return function (dispatch) {
    dispatch(getEvaluateProductId(id));
  };
};

exports.orderEvaluateId = orderEvaluateId;
...
var fetchProductsByOrderId = function fetchProductsByOrderId(id) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return regeneratorRuntime.awrap(fetch("".concat(_constants.root, "/api/package/").concat(id)));
...
exports.fetchProductsByOrderId = fetchProductsByOrderId;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 12:
            ...
            console.log('error from orderDuck', _context4.t2);
...
var fetchDeletedOrder = function fetchDeletedOrder(user_id, order_id) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 4;
            return regeneratorRuntime.awrap(fetch("".concat(_constants.root, "/api/package/delete"), {
              method: "DELETE",
              headers: {
                "content-Type": "application/json"
              },
          ...
          case 12:
            ...
            console.log('error from orderDuck', _context5.t2);
...
exports.fetchDeletedOrder = fetchDeletedOrder;
